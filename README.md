...
LurkBot is a community-driven Python port of [**OpenClaw**](https://github.com/moltbot/moltbot) by [Peter Steinberger](https://github.com/steipete). Special thanks to the Moltbot community for creating an incredible AI assistant platform.
